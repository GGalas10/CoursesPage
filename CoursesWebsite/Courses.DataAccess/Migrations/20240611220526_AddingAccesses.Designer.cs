...
namespace Courses.DataAccess.Migrations
{
    ...
    [Migration("20240611220526_AddingAccesses")]
    partial class AddingAccesses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Courses.Core.Models.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9cb22635-563b-4c59-b3c6-fff31dab05ed"),
                            Name = "User",
                            State = 0
                        },
                        new
                        {
                            Id = new Guid("0151523a-0757-4521-8394-3d85fdab068f"),
                            Name = "Admin",
                            State = 0
                        },
                        new
                        {
                            Id = new Guid("5cdfdb26-e9d1-46ed-8907-e6db0689f45c"),
                            Name = "Creator",
                            State = 0
                        });
                });
            ...
            modelBuilder.Entity("Courses.Core.Models.Users.User", b =>
                {
                    b.Navigation("CreatedUserCourses");

                    b.Navigation("PurchasedUserCourses");
